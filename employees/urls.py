...
urlpatterns = [
    ...
    path('employee/transfer_order', views.TransferCreateView.as_view(), name='employee-transfer'),
    path('employee/posting_order', views.PostingCreateView.as_view(), name='employee-posting'),
