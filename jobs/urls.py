...
urlpatterns = [
    ...
    path('initial/<int:pk>/delete', views.ScheduleDeleteview.as_view(), name='initial_delete'),
    path('final/<int:pk>/delete', views.FinalScheduleDeleteview.as_view(), name='final_delete'),
